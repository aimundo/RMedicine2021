...
.pull-left[
![:scale 50%](img/profile pic.jpg)
## Ariel Mundo
### PhD Candidate
]

.pull-right[
.fade[### Department of Biomedical Engineering<br>
University of Arkansas<br> Fayetteville, AR, USA
]

[`r icons::fontawesome("link")` aimundo.rbind.io](https://aimundo.rbind.io) <br>
...
```{r,GAM-tumor-plot,echo=FALSE,fig.align='center',fig.width=8,fig.height=5}
...
<table>
  ...
  <tr>
    <td>Covariance structures</td>
    <td> X</td>
    <td> 0 (rm-ANOVA) X(LMEMs)</td>
  </tr>
  <tr>
    <td>Prediction</td>
    <td> X</td>
